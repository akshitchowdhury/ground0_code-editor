...
export const AGENT_BLUEPRINTS = [
  { id: 'rag-qa', name: 'RAG Q&A Assistant', icon: '📚', desc: 'Answers questions grounded in your own documents.', requires: ['retriever', 'vectordb', 'guardrail'], template: 'rag-qa' },
  { id: 'chatbot', name: 'Conversational Chatbot', icon: '💬', desc: 'A multi-turn assistant that remembers the conversation.', requires: ['memory', 'guardrail'], template: 'chatbot' },
  { id: 'react-tool', name: 'Tool-using Agent', icon: '🛠️', desc: 'Reasons and calls tools / APIs to get things done (ReAct).', requires: ['tool', 'guardrail'], needsStop: true, template: 'react-tool' },
  { id: 'workflow', name: 'Automation Workflow', icon: '⚙️', desc: 'Multi-step task automation that can take real actions.', requires: ['tool', 'human', 'eval'], needsStop: true, template: 'workflow' },
  { id: 'multi-agent', name: 'Multi-agent System', icon: '🧭', desc: 'A supervisor delegating to specialist agents.', requires: ['router'], template: 'multi-agent' },
  { id: 'classifier', name: 'Classifier / Extractor', icon: '🏷️', desc: 'Structured output at scale — often fine-tuned, always evaluated.', requires: ['eval'], template: 'classifier' },
]
